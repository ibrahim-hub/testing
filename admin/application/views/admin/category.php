    ...
    <!-- ============================================================== -->
		<section role="main" class="content-body">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<form method="post" id="add_user" name="add_user" enctype="multipart/form-data" action="<?php echo site_url('admin/category/add');?>" data-parsley-validate novalidate>
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="category" class="form-control" title="Plase enter a category." placeholder="category" required="">
											</div>
